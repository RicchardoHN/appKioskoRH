...
export class DepartamentoEmpleadoControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation departamentoEmpleadoControllerGetEmpleado
   */
  static readonly DepartamentoEmpleadoControllerGetEmpleadoPath = '/departamentos/{id}/empleado';
  ...
  getEmpleado$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, DepartamentoEmpleadoControllerService.DepartamentoEmpleadoControllerGetEmpleadoPath, 'get');
    if (params) {
